...
The first wire contract is versioned JSONL over stdin/stdout. The optimizer owns
discovery, batching, guidance aggregation, hard eligibility, and route validity.
An addon only returns bounded guidance signals and diagnostics. Provider
failures are expected to degrade to neutral guidance.
